...
```
npm install btcnano-lib --save
npm install btcnano-payment-protocol --save
```

For client-side projects:

```
bower install btcnano-lib --save
bower install btcnano-payment-protocol --save
```
...
// send the transaction to the btcnano network
```
