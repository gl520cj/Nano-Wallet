...
angular.module('copayApp.services').factory('incomingData', function($log, $state, $timeout, $ionicHistory, bitcore, bitcoreCash, bitcoreNano,$rootScope, payproService, scannerService, appConfigService, popupService, gettextCatalog) {
  ...
  root.redir = function(data) {
    ...
    }else if (bitcoreNano.URI.isValid(data)) {
      var coin = 'Nano';
