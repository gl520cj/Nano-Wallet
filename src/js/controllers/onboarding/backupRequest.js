...
angular.module('copayApp.controllers').controller('backupRequestController', function($scope, $state, $stateParams, $ionicConfig, popupService, gettextCatalog) {
  ...
  $scope.openPopup = function() {
    ...
    var message = gettextCatalog.getString('If you forget your keyword or lose your device, your Nano will not be able to retrieve it without a backup.');
    ...
    popupService.showConfirm(title, message, okText, cancelText, function(val) {
      if (val) {
        ...
        var message = gettextCatalog.getString('It is advisable to back up after completing the wallet setup.');
